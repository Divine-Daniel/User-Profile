...
$userEmail = $_SESSION["invalid_email_check"]["useremail"] ?? null;

unset($_SESSION["invalid_email_check"]);
...
<body>
  ...
  <form action="<?= SITE_URL; ?>includes/forgetten_pswd_proccess.php" method="POST">
    ...
    <div class="form">
      ...
      <button type="text" class="submit" name="submit">Recover</button>
